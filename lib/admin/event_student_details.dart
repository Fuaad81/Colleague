...
class Event_Student_Details extends StatefulWidget {
  const Event_Student_Details({super.key});

  @override
  State<Event_Student_Details> createState() => _Event_Student_DetailsState();
}
